#' Plot the fitting heatmaps for the sample covariate test (with group difference). Similar to plotDiffFitHm() but this function will plot three columns of the heatmaps seperately.
#' 
...
#' @examples
#' plotDiffFitHm3(testobj = mantestobj, numSubsampleCell=10)

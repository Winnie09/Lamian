...
plotXDEHm <-
  function(testobj,
    ...
    col_fun = colorRamp2(seq(-max(abs(p1data)), max(abs(p1data)), length.out =
    ...
    col_fun = colorRamp2(seq(-max(abs(p2data)), max(abs(p2data)), length.out =
                               50), colorRampPalette(c(
                                 'blue3', 'skyblue', 'white', 'pink', 'red3'
                               ))(50))
    pt_col_fun = colorRamp2(seq(1, length(unique(
